...
<p>사용자의 편의성을 가장 먼저 생각하는 웹 프로그램 개발자 서재린입니다. 저에게 있어 편의성이란 그저 눈에 보기 좋게 꾸미는 것이 아닙니다. 사이버보안학과를 전공하며 <strong>"보이지 않는 설계의 견고함"</strong> 이 얼마나 중요한 것인지에 대해 배웠습니다. 특히 이러한 전공을 활용하여 <code> Linux </code>시스템과 <code> Python </code> 를 통해 보안 측면에서도 안전하여 신뢰할 수 있는 API 를 제작하는 것이 기본이라고 생각합니다. </p>

<ul>
  <li>
    <details open> <!--open 옵션으로 페이지를 열었을 때부터 내용이 나오도록 함--> 
    <summary><strong>성장하는 리더십과 책임감</strong></summary> <br>
    대학생활 3년간 줄곧 과학생회를 통해 소통 능력과 솔선소범하는 태도를 배웠습니다.1학년 때는 <strong>기획운영부원</strong>으로서 행사를 제작하고 보조하였으며, 2학년 때는 이러한 행사들의 기초 작업이 잘 진행되도록 행사 예산을 총괄하는 <strong>사무부장</strong> 역할을 맡았습니다. 3학년에는 추천을 받아 학과 내 <strong>부회장</strong>으로 신입생 오리엔테이션 총괄 기획과 같은 다양한 프로젝트를 이끌었습니다. 3년간 학생회 활동을 하는 것은 마치 프로젝트를 매 주 치뤄내는 것 같았습니다. 다양한 의견들을 수용하고, 가장 최적의 의견을 택하며, 돌발 상황에 대처하는 법을 배웠습니다. 이러한 경험은 수많은 사람과 소통하고 협력해야 하는 개발자에게는 큰 자산이 될 것입니다. <br>
    </details>
  </li>
 ...
 <br>
  ...
  <li>
    <details open>
    <summary><strong>꾸준함에 대한 증명</strong></summary> <br>
    저는 <strong>도전</strong>이라는 단어를 좋아합니다. 하지만 여러 도전을 선언해놓고 끝맺지 못하는 것은 온전한 도전이라 생각들지 않습니다. 도전이 일회성이 되지 않도록 <strong>꾸준함</strong>을 더하려 노력했습니다. 매년 겨울방학마다 **미국 단기 어학연수**에 참여한 것이 그 증거입니다. 낯선 환경에 적응하고 익숙치 않은 언어로 소통하는 것은 마치 복잡한 코드를 디버깅하는 것과 같았습니다. 실제 코드를 작동시키기 위해 오류를 끊임없이 찾아내야 하는 개발자에게 저의 꾸준함은 무기가 된다는 것을 알고 있습니다. <br>
      </details>
  </li>
 ...
 <br>
  ...
  <li>
     <details open>
    <summary><strong>기여할 수 있는 점</strong></summary> <br>
   저의 장점은 명확합니다. 사이버보안 전공으로 다진 <strong>보안성</strong>과 학생회 활동으로 기른 <strong>책임감</strong> 그리고 어학연수로 증명한 <strong>'꾸준함'</strong>을 저의 기술 역량에 더하는 것입니다. 동료들과 적극적으로 소통하며 시너지를 내고, 궁극적으로는 "사용자가 정말 편하게, 그리고 안심하고 쓸 수 있는" 견고한 API와 웹 서비스를 만드는 개발자가 되고 싶습니다.
       </details>
  </li>
</ul>
